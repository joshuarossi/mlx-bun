...
import { sampleSpeculativeRows } from "./round";
...
import { assertMlxSpeculativeBinding, bindLegacySpeculativeModel, type MlxSpeculativeBinding } from "../../execution/speculative/binding";
...
import { withModelUsageFlush, withModelWiredLimit, type GenerateOptions, type GenerateStats } from "../index";
...
import { makeSampler, makeStepSampler } from "../../sampling/index";
import type { OnToken } from "../../contracts/token-delivery";
...
export interface SpecRunServices {
  readonly prefixCache?: import("../../state/checkpoint").MlxPrefixCache;
