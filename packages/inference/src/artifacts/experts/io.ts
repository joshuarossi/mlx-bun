...
import { EXPERT_IO_LIBRARY } from "../../runtime/native";
import type { MlxArray } from "@mlx-bun/mlx/array";
import type { MlxHandle } from "@mlx-bun/mlx/ffi";
...
export class ExpertIOSlabStore {
  ...
  async releaseAfterGpuSync(
    ...
    const [{ gpuStream }, { synchronize }, ops] = await Promise.all([
      import("@mlx-bun/mlx/array"), import("@mlx-bun/mlx/ffi"), import("@mlx-bun/mlx/ops"),
    ]);
