...
const appDomains: Record<string, string[]> = { cli: ["engine", "server", "chat", "web", "jobs", "quantize", "dataset"], engine: [], chat: [], server: ["engine", "chat", "jobs", "quantize", "dataset"], quantize: ["jobs"], dataset: ["jobs"], jobs: [], web: ["chat", "jobs"] };
