...
const appDomains: Record<string, string[]> = { cli: ["engine", "server", "chat", "web", "jobs", "quantize", "finetune", "publishing"], engine: [], chat: [], server: ["engine", "chat", "jobs", "quantize", "finetune", "publishing"], quantize: ["jobs"], finetune: ["jobs"], publishing: [], jobs: [], web: ["chat", "jobs"] };
