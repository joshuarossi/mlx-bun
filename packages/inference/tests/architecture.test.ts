...
const appDomains: Record<string, string[]> = { cli: ["engine", "server", "chat", "web", "jobs", "quantize", "dataset"], engine: [], chat: [], server: ["engine", "chat", "memory", "jobs", "quantize", "dataset"], memory: [], quantize: ["jobs"], dataset: ["jobs"], jobs: [], web: ["chat", "jobs"] };
