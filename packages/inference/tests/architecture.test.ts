...
const appDomains: Record<string, string[]> = { cli: ["engine", "server", "chat", "web", "jobs", "quantize", "finetune"], engine: [], chat: [], server: ["engine", "chat", "jobs", "quantize", "finetune"], quantize: ["jobs"], finetune: ["jobs"], jobs: [], web: ["chat", "jobs"] };
