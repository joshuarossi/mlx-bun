...
const appDomains: Record<string, string[]> = { cli: ["engine", "server", "chat", "web", "jobs", "quantize", "memory"], engine: [], chat: [], server: ["engine", "chat", "memory", "jobs", "quantize"], memory: [], quantize: ["jobs"], jobs: [], web: ["chat", "jobs"] };
