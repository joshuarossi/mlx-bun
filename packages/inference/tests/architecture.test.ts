...
const appDomains: Record<string, string[]> = { cli: ["engine", "server", "chat", "web", "jobs", "quantize", "dataset", "finetune"], engine: [], chat: [], server: ["engine", "chat", "memory", "jobs", "quantize", "dataset", "finetune"], memory: [], quantize: ["jobs"], dataset: ["jobs"], finetune: ["jobs"], jobs: [], web: ["chat", "jobs"] };
