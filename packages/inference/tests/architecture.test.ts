...
const appDomains: Record<string, string[]> = { cli: ["engine", "server", "chat", "web", "jobs", "quantize", "dataset", "finetune", "publishing", "memory"], engine: [], chat: [], server: ["engine", "chat", "memory", "jobs", "quantize", "dataset", "finetune", "publishing"], memory: [], quantize: ["jobs"], dataset: ["jobs"], finetune: ["jobs"], publishing: [], jobs: [], web: ["chat", "jobs"] };
