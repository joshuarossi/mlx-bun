...
import { MlxArray, pinnedBufferCount } from "@mlx-bun/mlx/array";
import { clearCache, peakMemory, activeMemory, cacheMemory, resetPeakMemory } from "@mlx-bun/mlx/ffi";
...
export async function trainLora(
  ...
  const collect: TrainingProgressCallback = (e) => {
