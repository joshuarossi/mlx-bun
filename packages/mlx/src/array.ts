...
// frees leaked handles on GC.

import { hostBufferDestructor, type HostBuffer } from "./host-buffer";
...
/** Host-visible tensor metadata; the array owns the referenced memory. */
...
export const SAFETENSORS_TO_MLX = {
...
export type SafetensorsDtype = keyof typeof SAFETENSORS_TO_MLX;
