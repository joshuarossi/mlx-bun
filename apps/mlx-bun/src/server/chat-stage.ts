...
export class ChatStage {
  ...
  private async runPrepared(request: ChatRequest, requestId: string | undefined,
    ...
    let grammarCtrl: import("@mlx-bun/inference/sampling/grammar").GrammarController | null = null;
    const grammarReq =
    ...
    let fillSession: import("@mlx-bun/inference/generation/fill").FillSession | null = null;
