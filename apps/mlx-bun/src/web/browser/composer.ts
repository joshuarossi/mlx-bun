...
// TTFT, context-fill). Extracted from the original monolithic
...
import type { ReadyGenDefaults, SamplingOverrides } from "../../chat/protocol";
import { api } from "./api";
...
/* ────────────────────────────────────────────────────────────────────
   Perf strip: tok/s, TTFT, context-fill
   ──────────────────────────────────────────────────────────────────── */
