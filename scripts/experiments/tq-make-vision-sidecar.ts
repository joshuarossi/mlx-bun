...
//
//   bun scripts/experiments/tq-make-vision-sidecar.ts <trunk-dir> <artifact-dir>
...
if (!srcDir || !outDir) {
  console.error("usage: bun scripts/experiments/tq-make-vision-sidecar.ts <trunk-dir> <artifact-dir>");
  process.exit(1);
}
