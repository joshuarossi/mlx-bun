...
//
//   bun scripts/experiments/tq-equalize.ts <src-dir> <stats.json> <out-dir> [--alpha 0.5]
...
if (!srcDir || !statsPath || !outDir) {
  console.error("usage: bun scripts/experiments/tq-equalize.ts <src-dir> <stats.json> <out-dir> [--alpha 0.5]");
  process.exit(1);
}
