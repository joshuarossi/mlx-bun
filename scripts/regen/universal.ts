...
//
// Wraps scripts/oracle/gen-universal-golden.py in the oracle venv. Explicit token
...
if (!key) {
  console.error("usage: bun scripts/regen.ts universal <prefix>|all");
...
for (const e of selected) {
  ...
  const proc = Bun.spawn(
    [ORACLE_PYTHON, "scripts/oracle/gen-universal-golden.py",
