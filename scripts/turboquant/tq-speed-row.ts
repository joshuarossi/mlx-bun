...
// specServeRun harness (qwen38-mtp-ab.ts (deleted 2026-08-23; git history)) back-to-back
// in the same sitting.
//
//   bun scripts/turboquant/tq-speed-row.ts <model-dir> [lens=1024,8192,32768] [gen=128] [reps=3] [kv=plain|kv8|turbo|turbo:kXvY]
//
