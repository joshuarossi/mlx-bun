...
//
//   bun scripts/turboquant/w0-fold-llama.ts <src-model-dir> <out-dir> \
...
if (!srcDir || !outDir) {
  console.error("usage: bun scripts/turboquant/w0-fold-llama.ts <src-model-dir> <out-dir> [--seed N] [--skip-r1] [--skip-r2]");
  process.exit(1);
}
