...
//
//   bun qwen38-mtp-ab.ts (deleted 2026-08-23; git history) [maxTokens=128] [repeats=3]

const SNAPSHOT_QWEN38 = process.env.TQ_TRUNK!;
const SNAPSHOT_QWEN38_MTP = process.env.TQ_MTP!;
