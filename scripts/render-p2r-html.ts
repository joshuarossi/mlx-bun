...
//
// Usage:
//   bun scripts/render-p2r-html.ts INPUT.jsonl OUTPUT.html [VALIDATION.jsonl]
...
if (!inputPath || !outputPath) {
  throw new Error("usage: bun scripts/render-p2r-html.ts INPUT.jsonl OUTPUT.html [VALIDATION.jsonl]");
}
