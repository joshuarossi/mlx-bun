...
- `docs/planning/` — LIVING product/vision docs only: PRODUCT_ROADMAP, IDEAS, ResearchTopics, chunk-task-roadmap, curve-sampler-research-plan, memory-docs-and-dag-plan, pi-integration-review, release-notes-v0.2.0 (unpublished draft), video-series.
