...
- `docs/planning/` — product/vision: PRODUCT_ROADMAP, IDEAS, ResearchTopics, journal, chat-ui-vision, chat-ui-vision-memory-first, chunk-task-roadmap, curve-sampler-research-plan, memory-docs-and-dag-plan, pi-integration-review, web-ui-pass-plan, website-readme-pass-plan, release-notes-v0.0.9, release-notes-v0.0.10, release-notes-v0.0.11.
