// Compiled-decode parity gate (docs/archive/investigations/optimization_plan.md Phase A, step 5):
...
import { SNAPSHOT, SNAPSHOT_E4B, snapshotAvailable } from "../support/paths";
