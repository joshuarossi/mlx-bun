			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Drop-in for mlx-lm', slug: 'guides/drop-in-mlx-lm' },
						{ label: 'Personal memory', slug: 'guides/memory' },
						{ label: 'Model management', slug: 'guides/model-management' },
						{ label: 'Using the library', slug: 'guides/library' },
						{ label: 'Embedding in a Mac app', slug: 'guides/embedding' },
						{ label: 'Fine-tuning quickstart', slug: 'guides/fine-tuning-quickstart' },
