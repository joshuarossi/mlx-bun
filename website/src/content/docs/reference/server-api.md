---
title: Server API
description: OpenAI, Anthropic, and Responses HTTP endpoints, with full request/response schemas.
---
...
combinations compose, see [server-config.md](/reference/server-config/). This
