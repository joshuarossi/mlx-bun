...
it, and opens the chat UI at `http://localhost:8090/#/chat`. You're chatting in
under a minute.
...
const client = new OpenAI({ baseURL: "http://localhost:8090/v1", apiKey: "local" });
