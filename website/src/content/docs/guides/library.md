...
description: Embed MLX generation directly in a Bun process via loadContext / generate.
---
...
// Gemma4Model / MiniCPM5Model / Qwen35Model can still be imported directly
// from "mlx-bun" if you need the concrete type.
...
`/stats` — [server-api.md](/reference/server-api/).
