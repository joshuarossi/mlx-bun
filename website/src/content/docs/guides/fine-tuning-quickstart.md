...
description: "ORPO / DPO / SFT LoRA fine-tuning with the full preconfigured stack — one command."
editUrl: "https://github.com/joshuarossi/mlx-bun/edit/main/docs/reference/orpo-quickstart.md"
---
