...
| Installation and release | n/a | n/a | n/a | bundle, launchers, safe installer, formula and staged release preparation implemented | n/a | n/a | Finish GitHub/npm publication and tap synchronization with package versions/private decisions and clean-source checks; website/generated references and public installer delivery must follow a compatible bundle release; prior-data compatibility. Real signing/notarization acceptance remains a release step requiring Josh's instruction. No actual release. |
