...
- [~] **Shared execution and feature parity:** ordinary and speculative methods
      ...
      **Current:** Gemma media acceptance is complete with recorded latency costs. Qwen image/video acceptance also passes both-machine native/HTTP and M4 ABBA checks; Qwen encoder objects now share RAM/SSD storage and pass M1 ownership/HTTP checks; M4 integrated timing is in progress. **Remaining:** broader fill combinations,
