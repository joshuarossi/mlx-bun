...
- Cache expansion exit: each arm implemented and measured, compositional native/restart checks pass, and final M4 paired workload records benefits or regressions. Details: kv-cache §5.11.
