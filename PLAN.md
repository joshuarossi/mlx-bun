...
| | | | | | | | Improvement (owner: isolation): a pool cold start overlaps a running job's GPU use and leases only on ready; main's coordinator held cold starts back while a job ran. |
