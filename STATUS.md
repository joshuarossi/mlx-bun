...
| TurboQuant weights — Q campaign (sub-4 bpw) | **Q3 PASSED** (KL 0.1553 @ 3.55 bpw; flagship 0.1646 @ 4.80; MMLU 88 / tGSM 48 / rawGSM 44). **Q2b packed format LANDED 2026-09-02**: 12.14 GiB artifact, decode bit-identical to the fake-quant, KL 0.1550 through our engine, coherent generation; M1 Max decode **9.3 tok/s vs 18.9** flagship after three kernel rounds. **down_proj axis settled**: coding it along the INPUT dim (`--down-axis in`, all three projections on the plain reduce kernel) → **11.3 tok/s for KL 0.15543 vs 0.15501** and better top-1 — incoherence processing need not reach every coded axis. Carry-forward arm: `…-k300-downin-packed` (12.14 GiB) | Task columns (MMLU/tGSM/rawGSM) on the packed downin arm; Q5 2.75-budget arm; q2a/q2b task columns; rawGSM EOS-cliff root cause | chore/tame-jungle |
