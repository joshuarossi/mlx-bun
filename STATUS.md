...
| Interface-based engine refactor | Full R0–R10 design in engine architecture §12; implementation not started. Target: speed/quality/size frontier on Macs, with quant-specific graph and fused-method specialization behind stable sessions. | R0: verify/fix review findings and capture baselines; R1 contracts follow. Existing isolation and numerical implementations are migration inputs. | main |
